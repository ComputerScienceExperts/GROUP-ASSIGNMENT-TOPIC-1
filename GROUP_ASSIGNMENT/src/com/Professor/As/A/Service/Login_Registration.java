...
public class Login_Registration extends javax.swing.JFrame  {
    ...
    void readFile(){
        try {
            ...
            try {
                ...
                Logger.getLogger(Login_Registration.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    ...
    void addData(String usr,String pswd,String mail){
        try {
            ...
            raf.writeBytes("Role:"+mail);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(Login_Registration.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            for(int i=0;i<ln;i+=4){System.out.println("count "+i);
                ...
                if(usr.equals(forUser) & pswd.equals(forPswd)){
                    JOptionPane.showMessageDialog(null, "password matched");
                    MyFrame msdc=new MyFrame();
                    msdc.setVisible(true);
